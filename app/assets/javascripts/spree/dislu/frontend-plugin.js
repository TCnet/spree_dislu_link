jQuery(document).ready(function ($) {
    "use strict";
    function nozari_google_maps() {
        if ($('.nozari-google-maps').length <= 0) {
            return;
        }
        $('.nozari-google-maps').each(function () {
            var $this = $(this),
                $id = $this.attr('id'),
    ...
    // ----------nozari_custom_scrollbar-------------------
    function nozari_custom_scrollbar() {
        $('.nozari-mini-cart .minicart-items').mCustomScrollbar();
        $('.nozari-mini-cart .minicart-items').change(function () {
            $('.nozari-mini-cart .minicart-items').mCustomScrollbar();
        });
    }

    function nozari_custom_scrollbar_header_nav() {
    ...
    //------------------ Video Lightbox------------
    function nozari_video() {
        $('.quick-install').simpleLightboxVideo();
    }

    // --------------------remove_class_equal--------------------------
    function nozari_remove_class_review() {
    ...
    // -----------nozari_details_thumd--------------------
    function nozari_details_thumd_zoom() {
        /* ------------------------------------------------
         Arctic modal
         ------------------------------------------------ */
        if ($.arcticmodal) {
    ...
    /* ---------------------------------------------
     TAB EFFECT
     --------------------------------------------- */
    function nozari_tab_fade_effect() {
        // effect click
...
// ------------------owl-thumbs-----------------------------------------------
    ...
    function nozari_countdown() {
        if ($('.nozari-countdown').length > 0) {
            ...
            $('.nozari-countdown').each(function () {
    ...
    //nozari_masonry();
    nozari_dropdown();
    nozari_init_carousel();
    nozari_remove_class_review();
    //nozari_tab_fade_effect();
    nozari_details_thumd_zoom();
    nozari_video();
    kt_resizeMegamenu();
    //nozari_custom_scrollbar();
    //nozari_countdown();
    nozari_init_menu_toggle();
    //nozari_custom_scrollbar_header_nav();
}); 